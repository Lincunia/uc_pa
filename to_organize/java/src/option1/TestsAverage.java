...
{
    TestsAverage (StudentsData[] someStudents, double average,
                  double averageMax, int averageIndex, int i, int j)
    {
        for (i = 0; i < 3; i++)
            {
                average = 0;
    ...
    void
    printThem (StudentsData[] someStudents, double averageMax,
               int averageIndex, int i)
    {
        System.out.println (
            "The maximum average of the tests: "
