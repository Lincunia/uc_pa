...
\begin{itemize}
	\item
	      To identify the problem, we can ask questions such as:
	      \begin{itemize}
...
\begin{itemize}
	\item What features does the problem have?
...
\begin{itemize}
	\item
	      ...
	      It helps to understand what is the fundamental purpose of carrying out
        the project.
	\item
	      \textbf{Establish the Focus y Scope:}
	      Define which aspects of the problem will be addressed and which will
        not.
	\item
	      \textbf{Guides Subsequent Decisions:}
	      It provides guidance for decision-making in later stages of the
        project.
	\item
	      \textbf{Facilitates Communication:}
	      It enables clear and effective communication between team members and
        stakeholders.
	\item
	      \textbf{Facilitates the Evaluation of Results:}
	      By having a clear definition of the problem, it is possible to
